...
public class MyLinkedList implements IList {
    ...
    */    
    ...
    /**
    * Funçao q adiciona elementos em uma dada posiçao
    * tal que 0 é a 1ª possiçao e size()-1 é a ultima
    ...
    */
    ...
    public Object remove(int pos) {
     ...
     /**
    *retorna o objeto da posiçao index-1 sendo 0 a 1ª posiçao 
    * e size()-1 a ultima posiçao
